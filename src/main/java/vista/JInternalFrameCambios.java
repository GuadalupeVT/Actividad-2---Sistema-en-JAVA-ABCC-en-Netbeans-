 ...
 * @author guvad
 */
public class JInternalFrameCambios extends javax.swing.JInternalFrame {

    /**
     * Creates new form JInternalFrameBajas
     */
    public JInternalFrameCambios() {
        try {
            initComponents();
            actualizarTabla(cambiosTabla, "SELECT * FROM alumnos");
        } catch (SQLException ex) {
            Logger.getLogger(JInternalFrameCambios.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
