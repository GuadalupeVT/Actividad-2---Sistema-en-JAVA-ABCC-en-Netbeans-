...
public class Alumno {
	...
	public Alumno(String numControl, String nombre, String primerAp, String segundoAp, byte edad,byte semetre,
			String carrera) {
		super();
	...
	public String toString() {
		return "Alumno [numControl=" + numControl + ", nombre=" + nombre + ", primerAp=" + primerAp + ", segundoAp="
				+ segundoAp + ", edad=" + edad +", semetre=" + semetre + ", carrera=" + carrera + "]";
	}
